...
export default function RecipePage({ recipe }: RecipePageProps) {
  if (!recipe) {
    return (
      <div className="container mx-auto p-4 max-w-4xl">
        ...
        <Link href="/" className="text-blue-600 hover:text-blue-800 font-medium hover:underline mt-4 inline-flex items-center">
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <Link href="/" className="text-blue-600 hover:text-blue-800 font-medium hover:underline mb-6 inline-flex items-center">
        <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd"></path>
        </svg>
        Back to Home
